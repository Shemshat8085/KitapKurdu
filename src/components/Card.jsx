  ...
  return (
    <div className='card shadow h-100 d-flex flex-column overflow-hidden'>
        ...
        <div className="card-body p-3">
            ...
            <h4 className='card-subtitle text-secondary fs-5 mb-3 text-truncate'>{book.author}</h4>
        </div>

        <div className="card-footer border-0 p-3">
            <Link to={`/details/${book.id}`} className='btn btn-primary w-100 fw-bold'>Detay'a Git</Link>  
        </div>
    </div>
  )
}
